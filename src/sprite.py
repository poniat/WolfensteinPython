...
class Sprite:
    ...
    def __init__(self, game, type, path='assets/sprites/static/knight-armor.png', position=(29.5, 56.5), scale=1.0, shift=0.0):
    ...
    def get_sprite_projection(self):
        proj = SCREEN_DISTANCE_TO_PLAYER / self.norm_dist * self.SPRITE_SCALE
